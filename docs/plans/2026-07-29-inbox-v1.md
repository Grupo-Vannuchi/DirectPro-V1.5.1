...
- **Nomes compartilhados** — o que aparece em `import` ou em assinatura de
  função — em inglês. Variáveis locais podem ficar em português, que é a
  convenção já adotada no projeto (ver `docs/specs/2026-07-28-auditoria-e-refatoracao.md`,
  seção "Fase 3"). Comentários e texto de tela sempre em português.
